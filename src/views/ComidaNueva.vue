        ...
        <article class="caja-medidas">
          ...
          <div class="form-group cajita-cant" v-if="comida.empaque !== 'unidad'">
            ...
            <input
              ...
              class="form-control"
              id="cant-cajas"
              v-model="comida.packageQuantity"
            />
            <p v-if=" comida.empaque !== 'caja' ">El total de unidades es de: {{dependePaquete}}</p>
          </div>

          <div
            class="form-group cajita-cant"
            v-if="comida.empaque == 'unidad' || comida.empaque == 'caja'"
          >
            ...
            <p
              v-if="comida.empaque !== 'unidad'"
            >El total de unidades es de {{totalUnidades}} unidades</p>
          </div>
          <div class="form-group cajita-cant">
...
export default {
  computed: {
    empaques() {
      return this.comida && this.comida.medida
        ? this.medida.find(medida => medida.name === this.comida.medida).empaque
        : [];
    },
    // Calculo para obtener el total de unidades
    totalUnidades() {
      const totalUnidades =
        this.comida.packageQuantity * this.comida.amountUnity;
    ...
    nuevaComida() {
      if (this.totalUnidades) {
        ...
        this.comida.amountUnity =
          this.dependePaquete / this.comida.packageQuantity;
